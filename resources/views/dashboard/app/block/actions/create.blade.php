        ...
        <div class="row">
            <div class="col">
                <div class="card card-primary">
                    <div class="card-body">
                        <form action=" {{ route('dashboard.admin.block_store', $template->id) }}" method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-12 mb-3">
                                    <h6>Menambahkan block untuk:
                                        {{ $template->catalog }} -> <a
                                            href="{{ route('dashboard.admin.template_edit', $template->id) }}">{{ $template->template_name }}</a>
                                    </h6>
                                </div>

                                <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                    <label for="block_name"><span class="text-danger">*</span> Block Name</label>
                                    <input id="block_name" type="text" class="form-control" name="block_name" required>
                                ...
                                <input type="text" hidden value="{{ $template->id }}" name="template_id">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea class="form-control summernote-simple" name="block_body"
                                        id="text_tag_input" required></textarea>
