    ...
    <div class="card card-quote">
        <div class="card-body">
            ...
            <div class="text-right">
                <a href="{{ route('save' , $quote->id) }}" class="btn btn-light btn-sm btn-rounded"><i
                        class="mdi mdi-heart-outline align-middle"></i></a>
                @auth
            ...
            <div class="quote-author row">
                ...
                <div class="col-auto ml-auto">
                    ...
                    <a href="#" class="btn btn-light btn-sm btn-rounded"><i
                            class="mdi mdi-content-copy align-middle"></i></a>
                    <a href="#" class="btn btn-light btn-sm btn-rounded"><i
