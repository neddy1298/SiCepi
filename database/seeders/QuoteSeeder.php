...
class QuoteSeeder extends Seeder
{
    ...
    public function run()
    {
        $quotes = [[
            ...
            'user_id' => 1,
            'quote' => "The only abnormality is the incapacity to love.",
            'topics' => "Incapacity,Love,Only,To Love",
            'author' => "Anais Nin",
        ],[
            'user_id' => 1,
            'quote' => "Fine art is that in which the hand, the head, and the heart of man go together.",
            'topics' => "Art,Fine,FineArt,Go,Hand,Head,Heart,Man,Together,Which",
            'author' => "John Ruskin",
        ],[
            'user_id' => 1,
            'quote' => "If people think nature is their friend, then they sure don't need an enemy.",
